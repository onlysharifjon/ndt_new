...
XODIMLAR = [5172746353,328628941, 1207474771, 233029021, 49257001, 10414033, 2111796525, 856306959,520754113,524697244,322626456,1336680858]
...
async def send_welcome(message: types.Message):
    ...
    if xodim_id in XODIMLAR:
        await message.answer(f"<b>{ndt_users_dict[xodim_id]}</b> siz xodimlar bo`limidan foydalana olasiz",reply_markup=startbut)
